...
/**
 * Validates QR payloads from Odin.
 *
 * Checks (in order):
 *  1. JSON parseable
 *  2. version == 1
 ...
 *
 * Injected via Hilt — hmacKey provided as @Named("qrHmacKey").
 * In production the key comes from BuildConfig, injected in AppModule.
 */
